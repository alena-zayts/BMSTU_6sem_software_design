...
{
    public class CardReadingUI
    {
        public CardReadingUI(uint record_id, uint turnstile_id, uint card_id, uint reading_time)
        {
        ...
        public CardReadingUI((uint, uint, uint, uint) card_reading_tuple)
        {
        ...
        {
            return obj is CardReadingUI dB &&
