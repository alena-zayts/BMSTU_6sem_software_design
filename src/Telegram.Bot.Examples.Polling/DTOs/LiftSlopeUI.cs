...
{
    public class LiftSlopeUI
    {
        public LiftSlopeUI(uint record_id, uint lift_id, uint slope_id)
        {
        ...
        public LiftSlopeUI((uint, uint, uint) slope_tuple)
        {
