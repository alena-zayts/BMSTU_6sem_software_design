...
namespace SkiResortApp.ComponentAccessToDB.DBModels
{
    public class SlopeUI
    {
        ...
        public SlopeUI(uint slope_id, string slope_name, bool is_open, uint difficulty_level)
        {
        ...
        public SlopeUI((uint, string, bool, uint) slope_tuple)
        {
