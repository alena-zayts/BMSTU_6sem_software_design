...
namespace SkiResortApp.DbModels
{
    public class Slope
    {
        ...
        public Slope(uint slope_id, string name, bool is_open, uint difficulty_level)
        {
        ...
        {
            return ValueTuple.Create(slope_id, name, is_open, difficulty_level);
        }
