...
namespace SkiResortApp.ComponentAccessToDB.DBModels
{
    public class LiftDB
    {
        ...
        public LiftDB(uint lift_id, string lift_name, bool is_open, uint seats_amount, uint lifting_time, uint queue_time)
        {
        ...
        public LiftDB((uint, string, bool, uint, uint, uint) lift_tuple)
        {
