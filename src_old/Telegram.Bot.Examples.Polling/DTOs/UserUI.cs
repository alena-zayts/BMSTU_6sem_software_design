...
namespace SkiResortApp.ComponentAccessToDB.DBModels
{
    public class UserUI
    {
        public UserUI(uint user_id, uint card_id, string user_email, string password, uint permissions)
        {
        ...
        public UserUI((uint, uint, string, string, uint) user_tuple)
        {
