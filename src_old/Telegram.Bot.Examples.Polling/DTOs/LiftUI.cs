...
namespace SkiResortApp.ComponentAccessToDB.DBModels
{
    public class LiftUI
    {
        ...
        public LiftUI(uint lift_id, string lift_name, bool is_open, uint seats_amount, uint lifting_time, uint queue_time)
        {
        ...
        public LiftUI((uint, string, bool, uint, uint, uint) lift_tuple)
        {
