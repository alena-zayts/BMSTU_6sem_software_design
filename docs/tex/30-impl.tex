...
В любом окне неактивная кнопка означает, что данное действие недоступно данному пользователю. Например, в окне <<Профиль>> неавторизованный пользователь может выполнить вход или зарегистрироваться (рисунок \ref{img:profu}), авторизованный -- выполнить выход (рисунок \ref{img:profa}).
...
Далее для демонстрации всех функций системы окна будут показаны в том виде, в котором они открываются для пользователя с правами администратора.

На рисунке \ref{img:slopes} показан вид окна <<Спуски>>. 
